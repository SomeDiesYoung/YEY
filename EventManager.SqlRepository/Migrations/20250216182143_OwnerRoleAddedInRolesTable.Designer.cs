...
namespace EventManager.SqlRepository.Migrations
{
    ...
    [Migration("20250216182143_OwnerRoleAddedInRolesTable")]
    partial class OwnerRoleAddedInRolesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventManager.Identity.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EventManager.Identity.Models.ApplicationUserRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EventManager.Identity.Models.RefreshToken", b =>
                {
                    b.HasOne("EventManager.Identity.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("EventManager.Identity.Models.ApplicationUserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EventManager.Identity.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
